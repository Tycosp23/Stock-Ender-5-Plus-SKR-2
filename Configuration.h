...
#define STRING_CONFIG_H_AUTHOR "(C Kaelble, Creality Ender-5 Plus SKR 2 TFT 35 v3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "K_N_R 3D Printing and Design"
